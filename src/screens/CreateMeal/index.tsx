...
type CreateMealData = z.infer<typeof createMealSchema>
...
export function CreateMeal() {
  ...
  async function handleCreate(data: CreateMealData) {
    try {
      if (!selected) {
        Alert.alert(
          'Oops',
          'Você deve selecionar se alimentação está dentro ou fora da dieta.'
        )
      }
      ...
      Alert.alert(
        'Oops',
        'Ocorreu um erro ao criar a nova alimentação, por favor tente novamente.'
      )
    }
  }
